...
public class BuildingDTO extends AbstractDTO<BuildingDTO>{
    ...
    private List<String> staffStr;
    private List<String> staffAssignment;
    ...
    public void setStaffStr(List<String> staffStr) {
        this.staffStr = staffStr;
    }

    public List<String> getStaffAssignment() {
        return staffAssignment;
    }

    public void setStaffAssignment(List<String> staffAssignment) {
